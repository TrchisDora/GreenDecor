...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin') }}">
    @php
        $settings = DB::table('settings')->first(); // Lấy một bản ghi đầu tiên
    @endphp
                    
    <!-- Hiển thị logo -->
    @if ($settings && $settings->logo) 
        <img src="{{ asset($settings->logo) }}" alt="logo" width="50" height="50"> <!-- Đảm bảo logo có kích thước phù hợp -->
    @else
        <img src="{{ asset('default_logo.png') }}" alt="logo" width="50" height="50"> <!-- Nếu không có logo, hiển thị logo mặc định -->
    @endif
