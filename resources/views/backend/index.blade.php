...
@section('main-content')
  <div class="container-fluid">
    ...
    <div class="col-xl-8 col-lg-7">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Thống kê doanh thu tháng:</h6>
      </div>
      <!-- Card Body -->
      <div class="card-body">
        <div class="chart-area" style="width:100%; height:250px;">
  ...
  @push('scripts')
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const labels = [
      'Mới', 'Đã xử lý', 'Đang giao', 'Đã giao',
      'Yêu cầu hủy', 'Đã hủy', 'Thất bại', 'Hết hàng', 'Tại cửa hàng'
      ];
      ...
      data: {
        ...
        data: data,
        backgroundColor: [
          '#42a5f5', '#66bb6a', '#ffca28', '#7e57c2',
          '#ef5350', '#bdbdbd', '#8d6e63', '#ff7043', '#26c6da'
        ]
        }]
      },
      options: {
